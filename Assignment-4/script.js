...
function addCheckbox(e) {
        ...
        if (selected === "Flat White") {
          ...
          document.getElementById("spanTag").innerHTML = "<br> Any changes for Flat White drink?";
        } else if (selected === "Caffè Americano") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "<br> Any suggestions for Caffè Americano?";
        } else if (selected === "Caramel Macchiato") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "<br> Any issues with Caramel Macchiato?";
        } else if (selected === "Nitro Cold Brew") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "<br> Any issue with Nitro Cold Brew?";
        } else if (selected === "Any other drinks") {
            dynamicCheckbox.style.display = "block";
            checkboxSelectDynamic.value = "hi";
            document.getElementById("spanTag").innerHTML = "<br> Any other comments on specific drinks?";
          }else {
